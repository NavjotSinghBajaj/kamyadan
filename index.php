...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/responsive.css">
				...
				<script async src="https://www.googletagmanager.com/gtag/js?id=UA-167630609-1"></script>
				<script>
				  window.dataLayer = window.dataLayer || [];
				  function gtag(){dataLayer.push(arguments);}
				  gtag('js', new Date());

				  gtag('config', 'UA-167630609-1');
				</script>
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="coronatracker/india.php" target="_blank">India</a></li>
										<li class="nav-item"><a class="nav-link" href="coronatracker/world.php" target="_blank">World</a></li>
									</ul>
								</li>
		...
		<div class="banner_inner">
			<div class="container">
				<div class="banner_content">
					...
					<a class="primary_btn yellow_btn text-white" href="https://forms.gle/1wXrjAkMhi1ab99K8" target="_blank">Review Site</a>
				</div>
			</div>
		</div>
	</section>
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									...
									<div class="d-flex count_time">
										...
										<div class="mr-25">
											<h4><?php echo $data1{'activeCases'}; ?></h4>
											<p>Active</p>
										</div>
										<div class="mr-25">
		...
		<div class="container">
			...
			<div class="row team_inner">
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid" src="img/voluteer/navjot.JPG" alt="" width="263px" height="260px">
						</div>
						<div class="team_name">
							...
							<div class="social">
								<a href="https://www.facebook.com/navynavjot159/" target="_blank"><i class="fa fa-facebook"></i></a>
								<a href="https://www.linkedin.com/in/navjot-singh2" class="active" target="_blank"><i class="fa fa-linkedin"></i></a>
								<a href="https://www.instagram.com/navy2724/" target="_blank"><i class="fa fa-instagram"></i></a>
								<a href="mailto:singhnavjotb246@gmail.com" target="_blank"><i class="fa fa-envelope-o"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						...
						<div class="team_name">
							...
							<div class="social">
								<a href="https://instagram.com/_sarthak_2000_?igshid=f1b2vbrafho6" target="_blank"><i class="fa fa-facebook"></i></a>
								<a href="https://www.linkedin.com/in/dhruv-tewari-34a540133/" class="active" target="_blank"><i class="fa fa-linkedin"></i></a>
								<a href="https://www.instagram.com/tewaridhruv/?hl=en" target="_blank"><i class="fa fa-instagram"></i></a>
								<a href="mailto:dtewari2001@gmail.com" target="_blank"><i class="fa fa-envelope-o"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid" src="img/voluteer/arpit.png" alt="" width="263px" height="270px">
						</div>
						<div class="team_name">
							<h4>Arpit Chauhan</h4>
							...
							<div class="social">
								<a href="https://m.facebook.com/arpit.chauhan.566790" target="_blank"><i class="fa fa-facebook"></i></a>
								<a href="https://www.linkedin.com/in/arpit-chauhan-5727ba193" class="active" target="_blank"><i class="fa fa-linkedin"></i></a>
								<a href="https://www.instagram.com/arpitchauhan222/?hl=en" target="_blank"><i class="fa fa-instagram"></i></a>
								<a href="mailto:arpitchauhan2468@gmail.com" target="_blank"><i class="fa fa-envelope-o"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid" src="img/voluteer/sarthak.jpg" alt="" width="263px" height="260px">
						</div>
						<div class="team_name">
							...
							<div class="social">
								<a href="https://www.facebook.com/sarthak.agarwal.188" target="_blank"><i class="fa fa-facebook"></i></a>
								<a href="https://www.linkedin.com/in/sarthak-agrawal-0232a1167" class="active" target="_blank"><i class="fa fa-linkedin"></i></a>
								<a href="https://instagram.com/_sarthak_2000_?igshid=f1b2vbrafho6" target="_blank"><i class="fa fa-instagram"></i></a>
								<a href="mailto:sarthakagarwal26may@gmail.com" target="_blank"><i class="fa fa-envelope-o"></i></a>
							</div>
						</div>
					</div>
				</div>
